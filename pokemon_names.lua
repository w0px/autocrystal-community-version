-- pokemon_names.lua
-- National Dex names, indices 1-251 (Kanto + Johto).
-- Generation II's internal species index equals the National Dex number
-- directly (unlike Gen I/III, which use a scrambled internal order) -
-- confirmed against this bot's own logs (species #163 = Hoothoot matched
-- the on-screen "Wild HOOTHOOT appeared!" exactly, etc).
